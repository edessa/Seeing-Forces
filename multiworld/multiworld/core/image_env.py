...
class ImageEnv(ProxyEnv, MultitaskEnv):
    def __init__(
        ...
        self.bodies = ['tableTop', 'Geomclaw', 'rightclaw_it', 'leftclaw_it', 'puckbox']
        ...
        spaces['image_segmentation'] = img_space
    ...
    def _update_obs(self, obs):
        ...
        #print(self.model.geom_rgba)
        #print(self.model._geom_id2name)
    #    for body in self.bodies:
    #        color = self.model.geom_rgba[self.model._geom_name2id[body]]
        #applied_force = self.sim.data.xfrc_applied
        #gen_force = self.sim.data.qfrc_applied
        print(self.model._body_name2id)
        print(self.model.dof_bodyid)
        #print(functions.mj_name2id(self.model, 1, 'box'))
        #print(dir(self.sim.data))
        print(self.sim.data.qfrc_unc)
        #(len(self.model.site_names))

        #if max(applied_force.flatten()) != 0 or max(gen_force) != 0:
        #    print(applied_force)
        #    print(gen_force)
